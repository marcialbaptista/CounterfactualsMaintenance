...
from dice_ml_custom.explainer_interfaces.feasible_base_vae import FeasibleBaseVAE
from dice_ml_custom.utils.helpers import get_base_gen_cf_initialization
...
class FeasibleModelApprox(FeasibleBaseVAE, ExplainerBase):
    ...
    def __init__(self, data_interface, model_interface, **kwargs):
        ...
        # Data paths
        self.base_model_dir = '../../../dice_ml_custom/utils/sample_trained_models/'
