...
from dice_ml_custom.constants import BackEndTypes, ModelTypes
...
class Model:
    ...
    def __init__(self, model=None, model_path='', backend=BackEndTypes.Tensorflow1, model_type=ModelTypes.Classifier,
        ...
        :param backend: "TF1" ("TF2") for TensorFLow 1.0 (2.0), "PYT" for PyTorch implementations,
                        ...
                        inside the subpackage dice_ml_custom.model_interfaces, and dice interface class "DiceXGBoost"
                        in module "dice_xgboost" inside dice_ml_custom.explainer_interfaces, then backend parameter
...
def decide(backend):
    ...
    if backend == BackEndTypes.Sklearn:
        ...
        from dice_ml_custom.model_interfaces.keras_tensorflow_model import \
        ...
        from dice_ml_custom.model_interfaces.pytorch_model import PyTorchModel
        return PyTorchModel
        ...
        module = __import__("dice_ml_custom.model_interfaces." + module_name, fromlist=[class_name])
